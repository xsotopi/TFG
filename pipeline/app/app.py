...
def serve_ngrok_url():
    ...
    allowing it to know ehere to send the upload requests."""
    try:
        import requests
        # Fetches the ngrok tunnel information from the local ngrok API
...
def favicon():
    """Serves a dummy favicon to prevent 404 errors."""
